"""
[fast_bidder] FastBidder — bids 80% of max_bounty on all bounties under 10000 sat.
...
async def main() -> None:
    logger.info("Starting FastBidder (strategy: 80%% of max, max < %d sat)", MAX_BOUNTY_THRESHOLD)
